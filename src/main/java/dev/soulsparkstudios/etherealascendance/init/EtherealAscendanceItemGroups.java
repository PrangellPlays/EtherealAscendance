...
public class EtherealAscendanceItemGroups {
    public static final ItemGroup ETHEREAL_ASCENDANCE_ITEMS = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.etherealascendance.items")).icon(() -> new ItemStack(EtherealAscendanceItems.RATIONS)).entries((displayContext, entries) -> {
                ...
                entries.add(EtherealAscendanceBlocks.SPACE_HELMET_RAT);
            }).build());
